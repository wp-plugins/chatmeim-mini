...
class ShortCodes extends ChatMe {
	...
	function chatme_shortcode_menu() {
  		$my_admin_page = add_options_page('ChatMe Shortocode Help', 'ChatMe Shortcode Help', 'manage_options', $this->default['plugin_options_short'], array($this, 'mini_shortcode_help') );
	}
